...
app.get('/dashboard', (req, res) => {
    ...
    const roleDashboards = {
        ...
        'accountant': '/finance admin/finance_dashboard.html',
        ...
        'Recruitment staff': '/hr admin/hr_admin.html',
        'Payroll Officer': '/hr admin/hr_admin.html',   
        ...
        'procurement staff': '/scm admin/scm-dashboard.html',
        'Supply chain staff': '/scm admin/scm-dashboard.html',
